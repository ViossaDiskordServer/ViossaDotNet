	...
	home: {
		...
		data: {
			whatIsViossa: {
				...
				text: `
				اللغة الفيوسية هي لغة مسطنعة أبدعها الجماعة لتقليد تشكل لغات مبسطة طبيعية. تتميز الفيوسية بعدم توحيدها فيشكل كل متكلم لهجة شخصية خاصة به. يتغاير الهجاء واللفظ كثيرا فيستعملهما المتكلمون بشكل التعبير الشخصي. تُتعلّم وتُعلّم اللغة بالإنغماس فيها ويُمنع الترجمة أثناء التعلم.`,
				image: flakkaImg,
